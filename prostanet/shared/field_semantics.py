...
FIELD_REUSE_KEYS: dict[str, str] = {
    ...
    "dre_finding": "digital_rectal_exam",
    "dre_findings": "digital_rectal_exam",
    "dre_suspicious": "digital_rectal_exam",
...
FIELD_CAPTURE_LAYERS: dict[str, str] = {
    ...
    "dre_finding": "scenario_refiners",
    "dre_findings": "scenario_refiners",
    "dre_suspicious": "scenario_refiners",
...
FIELD_WHEN_TO_ASK: dict[str, str] = {
    ...
    "dre_finding": "Úselo cuando el tacto rectal pueda cambiar sospecha diagnóstica, indicación de MRI/biopsia o rebiopsia.",
...
FIELD_SCALE_SEMANTICS: dict[str, dict[str, Any]] = {
    ...
    "mini_cog_score": {
        ...
        "score_interpretation": "0-2 sugiere compromiso cognitivo; 3-5 hace menos probable deterioro significativo.",
    },
    "fatigue_score": {
