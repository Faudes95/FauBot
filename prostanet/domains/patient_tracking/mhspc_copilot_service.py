...
class MhspcCopilotService:
        ...
        *,
        ...
        return {
            ...
            "why_changed_today": prepend_metastatic_context(
                self._build_why_changed_today(payload, phenotype_summary, module_result),
                metastatic_composition_summary,
            ),
    ...
    def _build_phenotype_summary(
        ...
        return {
            ...
            "docetaxel_unfit": not bool((module_result.get("docetaxel_fitness") or {}).get("docetaxel_fit_summary", "")) and str(payload.get("docetaxel_fit", "1")) == "0",
        }
