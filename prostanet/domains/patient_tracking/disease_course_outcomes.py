...
def _build_adt_progression_outcomes(
    ...
    current_testosterone = _safe_float(_first_nonempty(latest_followup.get("testosterone_current"), merged.get("testosterone")))
...
def build_disease_course_bundle(
    ...
    *,
    ...
    try:
        survival_status = SurvivalEndpointService.compute_endpoints(survival_input, resolved_state).to_dict()
    except Exception:
        survival_status = {"endpoints": [], "active_endpoints": {}, "published_context": {}}
    benchmark_snapshots = _build_benchmark_snapshots(patient, resolved_state, resolved_track, merged, outcome_events)
