...
def build_patient_profile_view_model(
    *,
    ...
    return {
        ...
        "decision_refiner_contract": raw_result.get("decision_refiner_contract", {}),
        "preferred_treatment": raw_result.get("preferred_treatment", {}),
        "ranked_treatment_options": raw_result.get("ranked_treatment_options", []),
        "blocked_treatments": raw_result.get("blocked_treatments", []),
