...
def _mhspc_cases() -> list[dict[str, Any]]:
    return [
        ...
        _trajectory(
            ...
            clinical_oracle={"expected_effective_state": "mcspc_high_volume", "expected_action_contains": "Docetaxel", "expected_guideline_basis_any": ["NCCN 2026 mHSPC"], "hard_critical": True},
        ),
        _trajectory(
