...
AKEEGA_MHSPC = citation(
    ...
    applies_to_modules=["mcspc_oligo_metachronous", "mcspc_low_volume_sync_oligo", "mcspc_high_volume"],
...
MODULES = {
    ...
    "mcspc_low_volume_sync_oligo": ModuleEvidence(
        ...
        eau_sections=["Metastatic disease treatment"],
        pivotal_trials=["STAMPEDE H", "ARCHES", "ENZAMET", "TITAN"],
        core_questions=[
    ...
    "mcspc_high_volume": ModuleEvidence(
        ...
        eau_sections=["Metastatic disease treatment"],
        pivotal_trials=["CHAARTED", "LATITUDE", "ARASENS", "PEACE-1"],
        core_questions=[
