...
MCSPC_OLIGO_METACHRONOUS_SCHEMA = module_schema(
    ...
    fields=[
        FieldSpec("metastasis_count", "Número de metástasis", "number", required=True, default=3, group="Carga metastásica", group_order=1, clinical_role="required", unit="lesiones"),
        FieldSpec("metastasis_site", "Sitio metastásico", "select", required=True, options=["Bone", "Node", "Visceral"], default="Bone", group="Carga metastásica", group_order=1, clinical_role="required"),
        ...
        FieldSpec("baseline_qol", "Calidad de vida basal", "number", default=72, group="Resultados reportados por el paciente", group_order=4, clinical_role="monitoring", unit="0-100", evidence_tags=["qol"]),
    ],
)
